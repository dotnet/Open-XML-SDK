...
if (!(sd is null))
{
    ...
    if (worksheet != null)
    {
        ...
        string displayNameTom = "Tom Jebo";
        string idTom = string.Concat("{", System.Guid.NewGuid().ToString().ToUpper(), "}");
        ...
        string userIdTom = "tomjebo@microsoft.com";
        ...
        pp.PersonList = new PersonList(new Person() { DisplayName = displayNameTom, Id = idTom, UserId = userIdTom, ProviderId = providerIdAzure });
        ...
        wstcp.ThreadedComments = new ThreadedComments(
            ...
            { Ref = reference, PersonId = idTom, Id = tcId, DT = System.DateTime.Now });
    }
...
static void CreateMiscellaneousParts(SpreadsheetDocument? sd, string sheetName)
{
    if (sd == null)
    {
        return;
