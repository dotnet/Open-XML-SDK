...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void ElementCloneTest()
        {
            ...
            using (var doc = WordprocessingDocument.Open(stream, false))
            {
                ...
                Assert.Equal(paragraph.ParsedState.Attributes.Length, clonedParagraph.ParsedState.Attributes.Length);
                ...
                foreach (var elem in clonedDocument.Descendants())
                {
                    ...
                    Assert.Equal(curElem.ParsedState.Attributes.Length, elem.ParsedState.Attributes.Length);
