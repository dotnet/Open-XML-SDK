...
> There is a [prerelease version](https://www.nuget.org/packages/DocumentFormat.OpenXml/2.13.0-beta0001) available with support for Office 2019 types. Please try this out and let us know how it works for you. Please file any issues you find and label them with `Office2019`.
