...
namespace DocumentFormat.OpenXml.Tests.CommentExPeopleClass
{
    public class GeneratedDocument
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph(){ RsidParagraphAddition = "00743DCB", RsidRunAdditionDefault = "00C47703", ParagraphId = "6D2D761F", TextId = "77777777" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            LatentStyleExceptionInfo latentStyleExceptionInfo268 = new LatentStyleExceptionInfo(){ Name = "Plain Table 1", UiPriority = 40 };
            LatentStyleExceptionInfo latentStyleExceptionInfo269 = new LatentStyleExceptionInfo(){ Name = "Plain Table 2", UiPriority = 41 };
            LatentStyleExceptionInfo latentStyleExceptionInfo270 = new LatentStyleExceptionInfo(){ Name = "Plain Table 3", UiPriority = 42 };
            LatentStyleExceptionInfo latentStyleExceptionInfo271 = new LatentStyleExceptionInfo(){ Name = "Plain Table 4", UiPriority = 43 };
            LatentStyleExceptionInfo latentStyleExceptionInfo272 = new LatentStyleExceptionInfo(){ Name = "Plain Table 5", UiPriority = 44 };
            LatentStyleExceptionInfo latentStyleExceptionInfo273 = new LatentStyleExceptionInfo(){ Name = "Grid Table Light", UiPriority = 45 };
            ...
            Style style5 = new Style(){ Type = StyleValues.Character, StyleId = "CommentReference" };
            ...
            Rsid rsid5 = new Rsid(){ Val = "00C47703" };
            ...
            Style style6 = new Style(){ Type = StyleValues.Paragraph, StyleId = "CommentText" };
            StyleName styleName6 = new StyleName(){ Val = "annotation text" };
            BasedOn basedOn2 = new BasedOn(){ Val = "Normal" };
            LinkedStyle linkedStyle1 = new LinkedStyle(){ Val = "CommentTextChar" };
            UIPriority uIPriority5 = new UIPriority(){ Val = 99 };
            SemiHidden semiHidden5 = new SemiHidden();
            UnhideWhenUsed unhideWhenUsed5 = new UnhideWhenUsed();
            Rsid rsid6 = new Rsid(){ Val = "00C47703" };
            ...
            Style style7 = new Style(){ Type = StyleValues.Character, StyleId = "CommentTextChar", CustomStyle = true };
            StyleName styleName7 = new StyleName(){ Val = "Comment Text Char" };
            BasedOn basedOn3 = new BasedOn(){ Val = "DefaultParagraphFont" };
            LinkedStyle linkedStyle2 = new LinkedStyle(){ Val = "CommentText" };
            UIPriority uIPriority6 = new UIPriority(){ Val = 99 };
            SemiHidden semiHidden6 = new SemiHidden();
            Rsid rsid7 = new Rsid(){ Val = "00C47703" };
            ...
            Style style8 = new Style(){ Type = StyleValues.Paragraph, StyleId = "CommentSubject" };
            StyleName styleName8 = new StyleName(){ Val = "annotation subject" };
            BasedOn basedOn4 = new BasedOn(){ Val = "CommentText" };
            NextParagraphStyle nextParagraphStyle1 = new NextParagraphStyle(){ Val = "CommentText" };
            LinkedStyle linkedStyle3 = new LinkedStyle(){ Val = "CommentSubjectChar" };
            ...
            Rsid rsid8 = new Rsid(){ Val = "00C47703" };
            ...
            Style style9 = new Style(){ Type = StyleValues.Character, StyleId = "CommentSubjectChar", CustomStyle = true };
            StyleName styleName9 = new StyleName(){ Val = "Comment Subject Char" };
            BasedOn basedOn5 = new BasedOn(){ Val = "CommentTextChar" };
            LinkedStyle linkedStyle4 = new LinkedStyle(){ Val = "CommentSubject" };
            UIPriority uIPriority8 = new UIPriority(){ Val = 99 };
            SemiHidden semiHidden8 = new SemiHidden();
            Rsid rsid9 = new Rsid(){ Val = "00C47703" };
            ...
            LinkedStyle linkedStyle5 = new LinkedStyle(){ Val = "BalloonTextChar" };
            ...
            Rsid rsid10 = new Rsid(){ Val = "00C47703" };
            ...
            style10.Append(styleParagraphProperties1);
            ...
            LinkedStyle linkedStyle6 = new LinkedStyle(){ Val = "BalloonText" };
            UIPriority uIPriority10 = new UIPriority(){ Val = 99 };
            SemiHidden semiHidden10 = new SemiHidden();
            Rsid rsid11 = new Rsid(){ Val = "00C47703" };
        ...
        private void GenerateFontTablePart1Content(FontTablePart fontTablePart1)
        {
            ...
            Font font2 = new Font(){ Name = "MS Mincho" };
        ...
        private void GenerateWordprocessingCommentsExPart1Content(WordprocessingCommentsExPart wordprocessingCommentsExPart1)
        {
            ...
            W15.CommentEx commentEx1 = new W15.CommentEx(){ ParaId = "61B2BF87", Done = false };
            W15.CommentEx commentEx2 = new W15.CommentEx(){ ParaId = "216A897E", ParaIdParent = "61B2BF87", Done = false };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2012-10-05T05:32:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
