...
{
    public static class WebExtensionData
    {
        ...
        private static void GenerateWebExTaskpanesPart1Content(WebExTaskpanesPart webExTaskpanesPart1)
        {
        ...
        private static void GenerateWebExtensionPart2Content(WebExtensionPart webExtensionPart2)
        {
        ...
        private static void GenerateWebExtensionPart3Content(WebExtensionPart webExtensionPart3)
        {
        ...
        private static void GenerateImagePart2Content(ImagePart imagePart2)
        {
        ...
        private static void GenerateWebExtensionPart4Content(WebExtensionPart webExtensionPart4)
        {
        ...
        private static void GenerateImagePart3Content(ImagePart imagePart3)
        {
        ...
        private static void GenerateWebExtensionPart5Content(WebExtensionPart webExtensionPart5)
        {
