...
### Breaking change
- IDisposableFeature is now a part of the framework package and is available on each package and part. Extension methods to manage this feature have been removed as it no longer needs to be opted into. It now registers all disposable actions to be done at the package level instead of adding support at the part level.
