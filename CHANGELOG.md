...
- Added `CancellationToken` overloads to `SpreadsheetDocument.Open`, `WordprocessingDocument.Open`, and `PresentationDocument.Open` methods, allowing callers to observe cancellation before the document is opened (#1489)
