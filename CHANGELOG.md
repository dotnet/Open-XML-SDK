...
- `OpenXmlElement` no longer implements `IEnumerable<OpenXmlElement>`. If needed, access the `ChildElements` property or add your own extension method that returns an enumerator.
