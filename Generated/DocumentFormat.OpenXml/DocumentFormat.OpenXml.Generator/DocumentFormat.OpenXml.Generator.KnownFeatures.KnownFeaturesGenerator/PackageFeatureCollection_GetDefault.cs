...
public partial class OpenXmlPackage
{
    ...
    {
        private global::DocumentFormat.OpenXml.Features.IPartUriFeature? _PartUriHelper;
        ...
        private partial T? GetDefault<T>()
        {
            ...
            {
                if (_PartUriHelper is null)
                {
                    _PartUriHelper = new global::DocumentFormat.OpenXml.Packaging.PartUriHelper();
                }

                return (T)_PartUriHelper;
            }
