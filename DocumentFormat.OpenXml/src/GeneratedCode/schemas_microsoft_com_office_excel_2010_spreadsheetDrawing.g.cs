...
[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix")]
    [ChildElementInfo(typeof(ExcelNonVisualContentPartShapeProperties),(FileFormatVersions)14)]
...
if( 54 == namespaceId && "extLst" == name)
    ...
    public ExcelNonVisualContentPartShapeProperties ExcelNonVisualContentPartShapeProperties
    {
        get 
        {
            return GetElement<ExcelNonVisualContentPartShapeProperties>(0);
        }
        set
        {
            SetElement(0, value);
...
if( 54 == namespaceId && "cNvContentPartPr" == name)
    ...
    public override OpenXmlElement CloneNode(bool deep)
    {
        return CloneImp<ExcelNonVisualContentPartShapeProperties>(deep);
    }
