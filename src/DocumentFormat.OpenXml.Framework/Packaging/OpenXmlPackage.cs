...
namespace DocumentFormat.OpenXml.Packaging
{
    ...
    public abstract partial class OpenXmlPackage : OpenXmlPartContainer, IDisposable
    {
        ...
        /// <summary>
        /// Flushes the content, closes the document, and releases all resources. If the OpenXmlPackage.AutoSave property is true, the content will be saved before closing.
        /// </summary>
