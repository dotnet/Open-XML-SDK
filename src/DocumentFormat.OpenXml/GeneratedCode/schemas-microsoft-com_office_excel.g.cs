...
aBuilder.AddValidator(new RequiredValidator());
    ...
    public partial class MoveWithCells : OpenXmlLeafTextElement
    {
        ...
        {
            base.ConfigureMetadata(builder);
            builder.AddValidator<EnumValue<DocumentFormat.OpenXml.Vml.Spreadsheet.BooleanEntryWithBlankValues>>(new EnumValidator());
    ...
    public partial class CommentRowTarget : OpenXmlLeafTextElement
    {
        ...
        {
            base.ConfigureMetadata(builder);
            builder.AddValidator<IntegerValue>(new NumberValidator());
    ...
    public partial class ClipboardFormat : OpenXmlLeafTextElement
    {
        ...
        {
            base.ConfigureMetadata(builder);
            builder.AddValidator<EnumValue<DocumentFormat.OpenXml.Vml.Spreadsheet.ClipboardFormatValues>>(new EnumValidator());
