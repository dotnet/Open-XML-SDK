...
{
    internal static partial class CustomPropertyPartExtensions
    {
        /// <summary>
        /// Adds a CustomPropertyPart to a parent IAddExtensiblePart class.
        /// </summary>
        ...
        public static CustomPropertyPart AddCustomPropertyPart<T>(this T parent, PartTypeInfo partType, string? id = null)
            where T : OpenXmlPart, IAddExtensiblePartSupport<CustomPropertyPart>
        {
