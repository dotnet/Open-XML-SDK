...
namespace DocumentFormat.OpenXml.Validation.Semantic
{
    ...
    internal abstract class SemanticConstraint : ISemanticConstraint
    {
        ...
        protected static XmlQualifiedName GetAttributeQualifiedName(OpenXmlElement element, byte attributeID) => element.EState.Attributes[attributeID].Property.GetQName();
