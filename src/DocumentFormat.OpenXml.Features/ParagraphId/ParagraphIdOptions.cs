...
namespace DocumentFormat.OpenXml.Features
{
    ...
    {
        /// <summary>
        /// Gets a value indicating whether or not document changes should be tracked. If <c>false</c>, only calls to <see cref="IParagraphIdFeature.CreateUniqueParagraphId"/> will be tracked.
        /// </summary>
        public bool TrackDocument { get; init; } = true;
