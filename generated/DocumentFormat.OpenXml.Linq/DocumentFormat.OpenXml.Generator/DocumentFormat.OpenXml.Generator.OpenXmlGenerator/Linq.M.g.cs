...
namespace DocumentFormat.OpenXml.Linq
{
    ...
    public static partial class M
    {
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="A.graphicData" />, <see cref="A14.m" />, <see cref="deg" />, <see cref="den" />, <see cref="e" />, <see cref="fName" />, <see cref="lim" />, <see cref="num" />, <see cref="oMath" />, <see cref="oMathPara" />, <see cref="sub" />, <see cref="sup" />, <see cref="W.bdo" />, <see cref="W.customXml" />, <see cref="W.del" />, <see cref="W.dir" />, <see cref="W.fldSimple" />, <see cref="W.hyperlink" />, <see cref="W.ins" />, <see cref="W.moveFrom" />, <see cref="W.moveTo" />, <see cref="W.p" />, <see cref="W.rt" />, <see cref="W.rubyBase" />, <see cref="W.sdtContent" />, <see cref="W14.conflictDel" />, <see cref="W14.conflictIns" />.</description></item>
        ...
        /// <para>As an XML attribute, it:</para>
        /// <list type="bullet">
        /// <item><description>is contained in the following XML elements: <see cref="argSz" />, <see cref="baseJc" />, <see cref="brk" />, <see cref="brkBin" />, <see cref="brkBinSub" />, <see cref="count" />, <see cref="mathFont" />, <see cref="mcJc" />, <see cref="scr" />, <see cref="shp" />, <see cref="sty" />, <see cref="type" />.</description></item>
        /// <item><description>corresponds to the following strongly-typed properties: ArgumentSize.Val, BaseJustification.Val, Break.Val, BreakBinary.Val, BreakBinarySubtraction.Val, FractionType.Val, MathFont.Val, MatrixColumnCount.Val, MatrixColumnJustification.Val, Script.Val, Shape.Val, Style.Val.</description></item>
        /// </list>
        /// </remarks>
