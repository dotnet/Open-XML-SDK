...
namespace DocumentFormat.OpenXml.Linq
{
    ...
    public static class B
    {
        ...
        /// <item><description>has the following XML attributes: <see cref="NoNamespace.SelectedStyle" />, <see cref="NoNamespace.StyleName" />, <see cref="NoNamespace.URI_" />.</description></item>
