...
namespace DocumentFormat.OpenXml.Linq
{
    ...
    public static class W14
    {
        ...
        /// <summary>
        /// Represents the w14:prst XML attribute.
        /// </summary>
        /// <remarks>
        /// <para>As an XML attribute, it:</para>
        /// <list type="bullet">
        /// <item><description>is contained in the following XML elements: <see cref="camera" />.</description></item>
        /// <item><description>corresponds to the following strongly-typed properties: Camera.PresetCameraType.</description></item>
        /// </list>
        /// </remarks>
        ...
        /// <para>As an XML attribute, it:</para>
        /// <list type="bullet">
        /// <item><description>is contained in the following XML elements: <see cref="defaultImageDpi" />, <see cref="docId" />, <see cref="hueMod" />, <see cref="ligatures" />, <see cref="numForm" />, <see cref="numSpacing" />, <see cref="prstDash" />, <see cref="schemeClr" />, <see cref="srgbClr" />, <see cref="styleSet" />.</description></item>
        /// <item><description>corresponds to the following strongly-typed properties: DefaultImageDpi.Val, DocumentId.Val, HueModulation.Val, Ligatures.Val, NumberingFormat.Val, NumberSpacing.Val, PresetLineDashProperties.Val, RgbColorModelHex.Val, SchemeColor.Val, StyleSet.Val.</description></item>
        /// </list>
        /// </remarks>
        public static readonly XName val = w14 + "val";

        /// <summary>
        /// Represents the w14:w XML attribute.
        /// </summary>
        /// <remarks>
        /// <para>As an XML attribute, it:</para>
        /// <list type="bullet">
        /// <item><description>is contained in the following XML elements: <see cref="textOutline" />.</description></item>
        /// <item><description>corresponds to the following strongly-typed properties: TextOutlineEffect.LineWidth.</description></item>
        /// </list>
        /// </remarks>
