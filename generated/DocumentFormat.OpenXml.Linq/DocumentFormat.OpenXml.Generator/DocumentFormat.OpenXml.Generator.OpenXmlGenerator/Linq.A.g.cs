...
namespace DocumentFormat.OpenXml.Linq
{
    ...
    public static partial class A
    {
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="cell3D" />, <see cref="ln" />, <see cref="lnB" />, <see cref="lnBlToTr" />, <see cref="lnL" />, <see cref="lnR" />, <see cref="lnT" />, <see cref="lnTlToBr" />, <see cref="uLn" />, <see cref="A14.hiddenLine" />, <see cref="OAC.lineProps" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="bgFillStyleLst" />, <see cref="defRPr" />, <see cref="endParaRPr" />, <see cref="fill" />, <see cref="fillOverlay" />, <see cref="fillStyleLst" />, <see cref="grpSpPr" />, <see cref="pic" />, <see cref="rPr" />, <see cref="spPr" />, <see cref="tblPr" />, <see cref="tcPr" />, <see cref="uFill" />, <see cref="A14.hiddenFill" />, <see cref="C.spPr" />, <see cref="C14.spPr" />, <see cref="C15.spPr" />, <see cref="C16.spPr" />, <see cref="CDR.grpSpPr" />, <see cref="CDR.spPr" />, <see cref="CS.defRPr" />, <see cref="CS.spPr" />, <see cref="CX.spPr" />, <see cref="DGM.bg" />, <see cref="DGM.spPr" />, <see cref="DGM1612.spPr" />, <see cref="DSP.grpSpPr" />, <see cref="DSP.spPr" />, <see cref="OAC.grpSpPr" />, <see cref="P.bgPr" />, <see cref="P.grpSpPr" />, <see cref="P.spPr" />, <see cref="PIC.spPr" />, <see cref="WPC.bg" />, <see cref="WPG.grpSpPr" />, <see cref="WPS.spPr" />, <see cref="XDR.grpSpPr" />, <see cref="XDR.spPr" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="defPPr" />, <see cref="lvl1pPr" />, <see cref="lvl2pPr" />, <see cref="lvl3pPr" />, <see cref="lvl4pPr" />, <see cref="lvl5pPr" />, <see cref="lvl6pPr" />, <see cref="lvl7pPr" />, <see cref="lvl8pPr" />, <see cref="lvl9pPr" />, <see cref="pPr" />, <see cref="DGM1611.buPr" />, <see cref="OAC.pPr" />.</description></item>
        ...
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="defPPr" />, <see cref="lvl1pPr" />, <see cref="lvl2pPr" />, <see cref="lvl3pPr" />, <see cref="lvl4pPr" />, <see cref="lvl5pPr" />, <see cref="lvl6pPr" />, <see cref="lvl7pPr" />, <see cref="lvl8pPr" />, <see cref="lvl9pPr" />, <see cref="pPr" />, <see cref="DGM1611.buPr" />, <see cref="OAC.pPr" />.</description></item>
        /// <item><description>has the following XML attributes: <see cref="NoNamespace.@char" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="defPPr" />, <see cref="lvl1pPr" />, <see cref="lvl2pPr" />, <see cref="lvl3pPr" />, <see cref="lvl4pPr" />, <see cref="lvl5pPr" />, <see cref="lvl6pPr" />, <see cref="lvl7pPr" />, <see cref="lvl8pPr" />, <see cref="lvl9pPr" />, <see cref="pPr" />, <see cref="OAC.pPr" />.</description></item>
        /// <item><description>has the following child XML elements: <see cref="hslClr" />, <see cref="prstClr" />, <see cref="schemeClr" />, <see cref="scrgbClr" />, <see cref="srgbClr" />, <see cref="sysClr" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="ln" />, <see cref="lnB" />, <see cref="lnBlToTr" />, <see cref="lnL" />, <see cref="lnR" />, <see cref="lnT" />, <see cref="lnTlToBr" />, <see cref="uLn" />, <see cref="A14.hiddenLine" />, <see cref="OAC.lineProps" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="bgFillStyleLst" />, <see cref="defRPr" />, <see cref="endParaRPr" />, <see cref="fill" />, <see cref="fillOverlay" />, <see cref="fillStyleLst" />, <see cref="grpSpPr" />, <see cref="rPr" />, <see cref="spPr" />, <see cref="tblPr" />, <see cref="tcPr" />, <see cref="uFill" />, <see cref="A14.hiddenFill" />, <see cref="C.spPr" />, <see cref="C14.spPr" />, <see cref="C15.spPr" />, <see cref="C16.spPr" />, <see cref="CDR.grpSpPr" />, <see cref="CDR.spPr" />, <see cref="CS.defRPr" />, <see cref="CS.spPr" />, <see cref="CX.spPr" />, <see cref="DGM.bg" />, <see cref="DGM.spPr" />, <see cref="DGM1612.spPr" />, <see cref="DSP.grpSpPr" />, <see cref="DSP.spPr" />, <see cref="OAC.grpSpPr" />, <see cref="P.grpSpPr" />, <see cref="P.spPr" />, <see cref="PIC.spPr" />, <see cref="WPC.bg" />, <see cref="WPG.grpSpPr" />, <see cref="WPS.spPr" />, <see cref="XDR.grpSpPr" />, <see cref="XDR.spPr" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="cNvGrpSpPr" />, <see cref="CDR.cNvGrpSpPr" />, <see cref="DSP.cNvGrpSpPr" />, <see cref="OAC.cNvGrpSpPr" />, <see cref="P.cNvGrpSpPr" />, <see cref="WPG.cNvGrpSpPr" />, <see cref="XDR.cNvGrpSpPr" />.</description></item>
        /// <item><description>has the following child XML elements: <see cref="extLst" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="bodyPr" />, <see cref="effectStyle" />, <see cref="grpSpPr" />, <see cref="spPr" />, <see cref="C.spPr" />, <see cref="C14.spPr" />, <see cref="C15.spPr" />, <see cref="C16.spPr" />, <see cref="CDR.grpSpPr" />, <see cref="CDR.spPr" />, <see cref="CS.bodyPr" />, <see cref="CS.spPr" />, <see cref="CX.spPr" />, <see cref="DGM.spPr" />, <see cref="DGM1612.spPr" />, <see cref="DSP.grpSpPr" />, <see cref="DSP.spPr" />, <see cref="OAC.grpSpPr" />, <see cref="P.grpSpPr" />, <see cref="P.spPr" />, <see cref="PIC.spPr" />, <see cref="WPG.grpSpPr" />, <see cref="WPS.bodyPr" />, <see cref="WPS.spPr" />, <see cref="XDR.grpSpPr" />, <see cref="XDR.spPr" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="cont" />, <see cref="effectDag" />, <see cref="graphicFrame" />, <see cref="grpSpPr" />, <see cref="spPr" />, <see cref="txSp" />, <see cref="C.spPr" />, <see cref="C14.spPr" />, <see cref="C15.spPr" />, <see cref="C16.spPr" />, <see cref="CDR.grpSpPr" />, <see cref="CDR.spPr" />, <see cref="CS.spPr" />, <see cref="CX.spPr" />, <see cref="DGM.spPr" />, <see cref="DGM1612.spPr" />, <see cref="DSP.grpSpPr" />, <see cref="DSP.spPr" />, <see cref="OAC.grpSpPr" />, <see cref="P.grpSpPr" />, <see cref="P.spPr" />, <see cref="PIC.spPr" />, <see cref="WPG.grpSpPr" />, <see cref="WPS.spPr" />, <see cref="XDR.grpSpPr" />, <see cref="XDR.spPr" />.</description></item>
