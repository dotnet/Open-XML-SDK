...
namespace DocumentFormat.OpenXml.Linq
{
    ...
    public static class X
    {
        ...
        /// <item><description>has the following child XML elements: <see cref="alignment" />, <see cref="border" />, <see cref="fill" />, <see cref="font" />, <see cref="numFmt" />, <see cref="protection" />.</description></item>
        ...
        /// <para>As an XML element, it:</para>
        /// <list type="bullet">
        /// <item><description>has the following parent XML elements: <see cref="autoFilter" />, <see cref="bk" />, <see cref="c" />, <see cref="cacheField" />, <see cref="cacheHierarchy" />, <see cref="cacheSource" />, <see cref="calcChain" />, <see cref="calculatedItem" />, <see cref="calculatedMember" />, <see cref="cellStyle" />, <see cref="cfRule" />, <see cref="cfvo" />, <see cref="chartsheet" />, <see cref="comments" />, <see cref="conditionalFormat" />, <see cref="conditionalFormatting" />, <see cref="connection" />, <see cref="customSheetView" />, <see cref="customWorkbookView" />, <see cref="dataField" />, <see cref="dialogsheet" />, <see cref="externalLink" />, <see cref="filter" />, <see cref="filterColumn" />, <see cref="format" />, <see cref="futureMetadata" />, <see cref="groupLevel" />, <see cref="header" />, <see cref="ignoredErrors" />, <see cref="metadata" />, <see cref="nc" />, <see cref="oc" />, <see cref="pageField" />, <see cref="pivotArea" />, <see cref="pivotCacheDefinition" />, <see cref="pivotCacheRecords" />, <see cref="pivotField" />, <see cref="pivotHierarchy" />, <see cref="pivotTableDefinition" />, <see cref="queryTable" />, <see cref="queryTableField" />, <see cref="queryTableRefresh" />, <see cref="rcc" />, <see cref="rdn" />, <see cref="reference" />, <see cref="rfmt" />, <see cref="row" />, <see cref="rsnm" />, <see cref="sheetView" />, <see cref="sheetViews" />, <see cref="singleXmlCell" />, <see cref="sortState" />, <see cref="sst" />, <see cref="styleSheet" />, <see cref="table" />, <see cref="tupleCache" />, <see cref="userInfo" />, <see cref="volTypes" />, <see cref="workbook" />, <see cref="workbookView" />, <see cref="worksheet" />, <see cref="xf" />, <see cref="xmlCellPr" />, <see cref="xmlColumnPr" />, <see cref="xmlPr" />, <see cref="X14.pivotArea" />, <see cref="XNE.macrosheet" />, <see cref="XNSV.filter" />.</description></item>
        ...
        /// <item><description>has the following child XML elements: <see cref="calculatedColumnFormula" />, <see cref="totalsRowFormula" />, <see cref="xmlColumnPr" />.</description></item>
        /// <item><description>has the following XML attributes: <see cref="NoNamespace.dataCellStyle" />, <see cref="NoNamespace.dataDxfId" />, <see cref="NoNamespace.headerRowCellStyle" />, <see cref="NoNamespace.headerRowDxfId" />, <see cref="NoNamespace.id" />, <see cref="NoNamespace.name" />, <see cref="NoNamespace.queryTableFieldId" />, <see cref="NoNamespace.totalsRowCellStyle" />, <see cref="NoNamespace.totalsRowDxfId" />, <see cref="NoNamespace.totalsRowFunction" />, <see cref="NoNamespace.totalsRowLabel" />, <see cref="NoNamespace.uniqueName" />, <see cref="XR3.uid" />.</description></item>
