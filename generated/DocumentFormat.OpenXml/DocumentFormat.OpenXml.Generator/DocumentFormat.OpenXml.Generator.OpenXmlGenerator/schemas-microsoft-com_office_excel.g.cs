...
<<<<<<< HEAD
            ...
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.MinDropDownWidth.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.MinDropDownWidth());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.SelectionEntry.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.SelectionEntry());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.DropLines.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.DropLines());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Checked.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Checked());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarPosition.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarPosition());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarMin.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarMin());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarMax.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarMax());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarIncrement.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarIncrement());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarPageIncrement.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarPageIncrement());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarWidth.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScrollBarWidth());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptLanguage.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptLanguage());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptLocation.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptLocation());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Anchor.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Anchor());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.HorizontalTextAlignment.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.HorizontalTextAlignment());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.VerticalTextAlignment.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.VerticalTextAlignment());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaRange.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaRange());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.SelectionType.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.SelectionType());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.MultiSelections.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.MultiSelections());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ListBoxCallbackType.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ListBoxCallbackType());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ListItem.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ListItem());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.DropStyle.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.DropStyle());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaLink.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaLink());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaPicture.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaPicture());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaGroup.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaGroup());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptText.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptText());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptExtended.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ScriptExtended());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaTextBox.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaTextBox());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.AcceleratorPrimary.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.AcceleratorPrimary());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.AcceleratorSecondary.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.AcceleratorSecondary());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ClipboardFormat.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ClipboardFormat());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaMacro.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FormulaMacro());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.MoveWithCells.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.MoveWithCells());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ResizeWithCells.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ResizeWithCells());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Locked.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Locked());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.DefaultSize.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.DefaultSize());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.PrintObject.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.PrintObject());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Disabled.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Disabled());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.AutoFill.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.AutoFill());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.AutoLine.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.AutoLine());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.AutoSizePicture.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.AutoSizePicture());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.LockText.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.LockText());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.JustifyLastLine.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.JustifyLastLine());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.SecretEdit.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.SecretEdit());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.DefaultButton.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.DefaultButton());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.HelpButton.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.HelpButton());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.CancelButton.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.CancelButton());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.DismissButton.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.DismissButton());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Visible.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Visible());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.RowHidden.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.RowHidden());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ColumnHidden.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ColumnHidden());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.MultiLine.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.MultiLine());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.VerticalScrollBar.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.VerticalScrollBar());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.ValidIds.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.ValidIds());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Disable3DForListBoxAndDropDown.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Disable3DForListBoxAndDropDown());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Colored.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Colored());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.Disable3D.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.Disable3D());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.FirstButton.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.FirstButton());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.HorizontalScrollBar.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.HorizontalScrollBar());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.MapOcxControl.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.MapOcxControl());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.CameraObject.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.CameraObject());
            builder.AddChild(DocumentFormat.OpenXml.Vml.Spreadsheet.RecalculateAlways.ElementType, static () => new DocumentFormat.OpenXml.Vml.Spreadsheet.RecalculateAlways());
